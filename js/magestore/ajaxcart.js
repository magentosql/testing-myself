...
Ajaxcart.prototype = {
    ...
    addToCartHandle: function(requestUrl, params){
        ...
        if(!window.location.href.match('https://') && requestUrl.match('https://'))
            requestUr = requestUrl.replace('https://','http://');
    ...
    addToCartFinish: function(response){
        ...
        if (this.getMiniCart() && response.miniCart){
            ...
            jQuery("#mini-cart .block-content").stop(true, true).delay(10).fadeIn(500, "easeOutCubic");
...
AjaxcartCompare.prototype = {
    ...
    addToCompareHandle: function(requestUrl, params){
        ...
        if (params.search("wishlist") >= 0 ){

            //$("#link-wishlist").hide();
            //alert("Added to wishlist");
            jQuery("#messages_product_view").html("" +
                "<div class='success-msg'>Added to wishlist </div>" );
            jQuery(".product-nav").css("margin-top","auto");
        ...
        this.requestAjax = new Ajax.Request(requestUrl,{
            ...
            parameters: params,
            onException: function (xhr, e){
                jQuery(this.ajaxMask).hide();
                jQuery(this.ajaxPopup).hide();
                window.location.href = this.url;
            },
            onComplete: this.ajaxOnComplete
        });

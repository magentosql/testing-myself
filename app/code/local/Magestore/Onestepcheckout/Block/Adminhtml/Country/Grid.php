...
class Magestore_Onestepcheckout_Block_Adminhtml_Country_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
            ...
            array(
                ...
                'actions'   => array(
                    array(
                        ...
                        'url'       => array('base'=> 'onestepcheckout/adminhtml_country/showCountryIp'),
                        'field'     => 'id',						
    ...
    {
		$link = Mage::getSingleton('adminhtml/url')->getUrl('onestepcheckout/adminhtml_geoip/showGeoip',array(

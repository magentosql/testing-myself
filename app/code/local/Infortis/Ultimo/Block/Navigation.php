...
class Infortis_Ultimo_Block_Navigation extends Mage_Core_Block_Template
{
    ...
    public function getCategoryFilterUrl($category, $type, $item, $url_key)
    {
        ...
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false, $staticBlock = false)
    {
        ...
        if($staticBlock) {  
               ...
               ($staticBlock ==  'block_header_nav_fabric'))
            {
                ...
                $html[] = $this->getChildHtml('block_header_nav_whatsnew');
                $html[] = '</div><div class="custom-block">';
                $html[] = $this->getChildHtml('block_header_nav_featured');
                $html[] = '</div>       
                </div>
                </div>';

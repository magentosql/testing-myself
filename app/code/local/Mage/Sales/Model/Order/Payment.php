    ...
    public function registerCaptureNotification($amount)
    {
        ...
        if (!$invoice) {
            if ($this->_isCaptureFinal($amount)) {
                ...
                $this->setIsFraudDetected(false); //AuthorizeCIM 2011
...
//    }
     ...
     *
     * To make sure transaction object won't cause trouble before saving, use $failsafe = true //AuthorizeCIM 2011
     *
     * @param string $type
     ...
     */
    protected function _addTransaction($type, $salesDocument = null, $failsafe = true)
    {

...
abstract class Mirasvit_Advd_Block_Adminhtml_Widget_Abstract extends Mage_Adminhtml_Block_Widget
{
    ...
    public abstract function prepareOptions();
    ...
    public function getConfigurationForm()
    {
        ...
        $this->_form->addField('widget', 'select', array(
                'name'      => 'widget',
        ...
        $this->_form->addField('title', 'text', array(
                'name'      => 'title',
        ...
        $this->_form->addField('buttons', 'note', array(
                'name'      => 'buttons',
                'label'     => '',
                'text'      => '

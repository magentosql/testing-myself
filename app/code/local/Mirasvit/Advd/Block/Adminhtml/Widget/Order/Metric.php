...
class Mirasvit_Advd_Block_Adminhtml_Widget_Order_Metric
    extends Mirasvit_Advd_Block_Adminhtml_Widget_Abstract_Metric
{
    ...
    {
        $this->_form->addField('metric', 'select', array(
                'name'   => 'metric',
        ...
        $this->_form->addField('compare_with', 'select', array(
                'name'   => 'compare_with',
    ...
    protected function getTotals($intervalCode, $compareWith = false)
    {
        ...
        $orders->setFilterData($filterData);

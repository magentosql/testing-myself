...
class Mirasvit_Advd_Block_Adminhtml_Widget_Order_Chart
    extends Mirasvit_Advd_Block_Adminhtml_Widget_Abstract_Chart
{
    ...
    public function prepareOptions()
    {
        ...
        $this->_form->addField('metrics', 'multiselect', array(
                'name'      => 'metrics',
        ...
        $this->_form->addField('range', 'select', array(
                'name'      => 'range',
        ...
        $this->_form->addField('limit', 'text', array(
                'name'      => 'limit',
    ...
    protected function _getCollection()
    {
        if (!$this->hasData('collection')) {
            ...
            $collection->setFilterData($filterData)
                ->groupByPeriod()

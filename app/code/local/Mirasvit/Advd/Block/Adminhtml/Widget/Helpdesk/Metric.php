...
class Mirasvit_Advd_Block_Adminhtml_Widget_Helpdesk_Metric
    extends Mirasvit_Advd_Block_Adminhtml_Widget_Abstract_Metric
{
    ...
    public function prepareOptions()
    {
        ...
        $this->_form->addField('status_ids', 'multiselect', array(
                'name'   => 'status_ids',
        ...
        $this->_form->addField('priority_ids', 'multiselect', array(
                'name'   => 'priority_ids',
        ...
        $this->_form->addField('owner_id', 'select', array(
                'name'   => 'owner_id',

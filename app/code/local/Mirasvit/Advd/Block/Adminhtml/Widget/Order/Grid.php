...
class Mirasvit_Advd_Block_Adminhtml_Widget_Order_Grid
    extends Mirasvit_Advd_Block_Adminhtml_Widget_Abstract_Grid
{
    ...
    public function _prepareCustomerName($row, $row, $column)
    {

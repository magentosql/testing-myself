...
class Mirasvit_Advr_Block_Adminhtml_Product_Attribute_Detail
    extends Mirasvit_Advr_Block_Adminhtml_Block_Container
{
    public function _prepareLayout()
    {
        ...
        $this->setHeaderText(
            Mage::helper('advr')->__('Sales Report for "%s is %s"',
                Mage::registry('current_attribute')->getFrontendLabel(),
                Mage::registry('current_option')
            )
        );
    ...
    public function _prepareCollection($filterData)
    {
        ...
        $products->addFilterByAttributeOptionId(Mage::registry('current_attribute'), Mage::registry('current_value'));

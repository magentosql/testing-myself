...
class Mirasvit_Advr_Block_Adminhtml_Order_City extends Mirasvit_Advr_Block_Adminhtml_Order_Abstract
{
    public function _prepareLayout()
    {
        ...
        $this->setHeaderText(Mage::helper('advr')->__('Sales By City'));

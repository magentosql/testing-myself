...
{   protected $_code  = 'authorizecimsoap';
	...
	public function createCustomerXML($ccnum, $CustomerEmail, $ExpirationDate, $CustomerId20, $billToWho, $cvv, $storeId=0) {
		...
		$billTo->addChild('address',preg_replace('/[^A-Za-z0-9_]/', '', $billToWho->getStreet(1)." ".$billToWho->getStreet(2)));
	...
	public function createCustomerShippingAddressXML($CustProfile, $shipToWho, $storeId=0) {
		...
		$shipTo->addChild('address',preg_replace('/[^A-Za-z0-9_]/', '', $shipToWho->getStreet(1)." ".$shipToWho->getStreet(2)));

...
$cmsPageData = array(
    'content' => str_replace('{{store url="/checkout/cart/add"}}', '{{store url="checkout/cart/add"}}', $pageContent)
);
                ...
                <li class="wide">
                    <div class="input-box">
                        <select name="sample" id="sample" class="validate-select" title="Choose Your Sample" placeholder="Choose Your Sample">
                            <option class="label" disabled selected value="" style="display:none;">Choose Your Sample</option>

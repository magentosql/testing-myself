<?php
class Wsnyc_CheckoutCustomization_Model_Sales_Quote_Address_Total_Giftwrap extends Mage_Sales_Model_Quote_Address_Total_Abstract {
    ...
    public function fetch(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        if ($amount!=0) {
            Mage::log($this->getCode(),null,'qw.log');

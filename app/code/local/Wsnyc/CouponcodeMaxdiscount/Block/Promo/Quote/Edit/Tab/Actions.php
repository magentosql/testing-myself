...
class Wsnyc_CouponcodeMaxdiscount_Block_Promo_Quote_Edit_Tab_Actions
extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions
{
    ...
    protected function _prepareForm()
    {
        ...
        /*just this field has been added*/
        $fieldset->addField('maxdiscount', 'text', array(
            'name' => 'maxdiscount',
            'required' => true,
            'class' => 'validate-not-negative-number',
            'label' => Mage::helper('salesrule')->__('Maximum Discount Amount (value, not percent)'),
        ));
        $model->setMaxdiscount($model->getMaxdiscount()*1);

...
class Ic_InternationalCheckout_Block_International extends Mage_Core_Block_Template {
	...
	function shippingPrice () {
		...
		//print_r($shippingCarrierMethodArr);
		if($shippingCarrierMethodArr[0] == 'fedex' && $shippingCarrierMethodArr[1] == 'GROUND' && $shippingCarrierMethodArr[2] == 'HOME' && $shippingCarrierMethodArr[3] == 'DELIVERY' ){

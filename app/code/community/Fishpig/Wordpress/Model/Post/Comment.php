...
class Fishpig_Wordpress_Model_Post_Comment extends Fishpig_Wordpress_Model_Abstract
{
	...
	// TODO: Fix this. It's very broken. And right now it won't work with our routing setup in fishpig.
	public function getAnchor()
	{
		$helper = Mage::helper('core');
		return sprintf('<a href="%s" title="%s">%s</a>', $this->getUrl(), 
			/*$helper->escapeHtml($this->getCommentAuthor()), $helper->escapeHtml($this->getPost()->getPostTitle())*/
			"Link");
	}
}

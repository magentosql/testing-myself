...
class WgCommon
{
	...
	function responce($responseArray) {
...
class Categories
{
	...
	{
		$this->responseArray['Categories'] = $this->Categories?$this->Categories:'';
		return $this->responseArray;
	}
...
class Customers
{
	...
	{
		$this->responseArray['Customer'] = $Customer?$Customer:'';
	}
